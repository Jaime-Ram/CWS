...
const uitvoering = [
  ...
  },
  {
    ...
    a: "Meestal niet volledig. Wij werken bij voorkeur in de avond, de nacht of het weekend en fasereren waar nodig per bouwdeel, zodat uw bedrijfsvoering doorloopt.",
  },
  {
    ...
    <>
      ...
      <Section>
        ...
        <div className="mx-auto max-w-[880px]">
          <h2>Wetgeving en verplichtingen</h2>
          <Faq items={algemeen} className="mt-8" />

          <h2 className="mt-16">Onderhoud en frequenties</h2>
          <Faq items={praktisch} className="mt-8" />

          <h2 className="mt-16">Uitvoering en spoed</h2>
          <Faq items={uitvoering} className="mt-8" />
        </div>
      </Section>
